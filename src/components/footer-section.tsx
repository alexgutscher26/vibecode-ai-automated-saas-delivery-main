...
const Footer2 = ({
  logo = {
    ...
    alt: "VibeCode AI logo",
    title: "VibeCode AI",
    url: "https://www.vibecode.ai",
  },
  tagline = "Autonomous product delivery from idea to deploy.",
  menuItems = [
    {
      title: "Platform",
      links: [
  ...
  copyright = "© 2025 VibeCode AI. Autonomous engineering at scale.",
  bottomLinks = [
