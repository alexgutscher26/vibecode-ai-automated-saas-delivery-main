            ...
            <div className="mb-2 max-w-4xl">
              ...
              >
                <span className="text-muted-foreground">
                  Accelerate Product Delivery From
                </span>{" "}
                Ideation to Deployment — Automatically
              </motion.h2>
            </div>
            <p className="text-muted-foreground max-w-[30rem] text-balance text-left text-base leading-snug tracking-wide sm:text-lg">
              Transform any SaaS concept into a validated blueprint and execution pipeline powered by autonomous agents.
            </p>
          </div>
        </div>
